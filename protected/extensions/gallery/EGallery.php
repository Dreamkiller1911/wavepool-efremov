 ...
 * EGallery class file.
 *
 * EGallery provides a simple media for use with {@link http://www.yiiframework.com Yii Framework}
 ...
 *
 * How do I use this?
 * Choose a location to store the photos: eg. /images/media
 *
 * Create some "albums" in the media and put your photos in there eg.
 *     +-images/
 *       +-media/
 *         +-sample/
 *         | +-image1.jpg
 ...
 *
 *
 * If you name your folder by date (eg. 20091120) you can sort your media by
 ...
 * ~~~
 * [php]
 * $this->widget('application.extensions.media.EGallery',
 * 		array('path' => '/images/media'),
 * );
 * [/php]
 * ~~~
 *
 ...
 * directories inside the media directory. Sub albums are currently not supported.
 *
...
Yii::import('application.extensions.media.*');
